  ...
  <main>
    ...
    <div class="member py-5">
      <div class="container mt-5">
        <div class="team p-0">
          <ul class="row">
            <li class="col-lg-3 col-md-6 mb-5">
              <div class="row">
        ...
        <li class="list">
          <div class="con">
            <article>
              ...
              <h3>迷聲 1.0 正式上線</h3>
              <h5>為了提升台灣音樂風氣，每個夥伴經過數百個小時的努力，一邊學習、一邊創作，將迷聲應寫出來</h5>
            </article>
          </div>
        </li>
        <li class="list">
        ...
        <li class="list">
          <div class="con">
            <article>
              ...
              <h3>迷聲 2.0 正式上線</h3>
              <h5>因為受到許多音樂人支持，畢業後的我們決定繼續經營迷聲，希望可以幫助到有需要的人。為了讓使用者能操作得更為順暢，我們做了一次大改版</h5>
            </article>
          </div>
        </li>
        <li class="list">
          <div class="con">
            <article>
              ...
              <h3>里程碑: 會員破千名</h3>
              <h5>會員破千名、粉絲專頁也突破三千讚，已配對 500 位樂手，每月活耀使用者突破兩千人</h5>
            </article>
          </div>
        </li>
      </ul>
...
.process{
  ...
  &::before{
    // 直線
    content: '';
    background-image: linear-gradient(#BE93C5, rgba(#7BC6CC, 0.5));
    width: 3px;
    position: absolute;
    height: 100%;
    right: auto;
  ...
  &::after{
    content: '';
    background-image: linear-gradient(rgba(#7BC6CC, 0.5), rgba(#7BC6CC, 0));
    width: 3px;
    position: absolute;
    bottom: -50px;
    height: 50px;
...
.con{
  ...
  article{
    ...
    border-radius: 5px;
    box-shadow: 3px 3px 10px rgba(#000, 0.1);
    p{
      font-weight: bold;
      color: #ccc;
      margin-bottom: 0;
